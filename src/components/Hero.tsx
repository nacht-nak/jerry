            ...
            <div className="mt-12 pt-8 border-t border-slate-800/80 grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-2xl">
              <div className="p-4 rounded-2xl bg-dark-900/80 border border-slate-800 hover:border-cyan-500/30 transition-all">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-xl sm:text-2xl font-extrabold font-mono text-gradient-cyan">100%</div>
                  <div className="p-1.5 rounded-lg bg-cyan-950/50 text-cyan-400 border border-cyan-500/20">
                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
                    </svg>
                  </div>
                </div>
                <div className="text-xs text-slate-400">Client Focus & Dedication</div>
              </div>
              <div className="p-4 rounded-2xl bg-dark-900/80 border border-slate-800 hover:border-cyan-500/30 transition-all">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-xl sm:text-2xl font-extrabold font-mono text-cyan-400">1+ Yr</div>
                  <div className="p-1.5 rounded-lg bg-cyan-950/50 text-cyan-400 border border-cyan-500/20">
                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="text-xs text-slate-400">Digital Marketing & Ads</div>
              </div>
              <div className="p-4 rounded-2xl bg-dark-900/80 border border-slate-800 hover:border-cyan-500/30 transition-all">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-xl sm:text-2xl font-extrabold font-mono text-indigo-400">GA4/GTM</div>
                ...
                <div className="text-xs text-slate-400">Multi-Channel Analytics</div>
              </div>
              <div className="p-4 rounded-2xl bg-dark-900/80 border border-slate-800 hover:border-cyan-500/30 transition-all">
                <div className="flex items-center justify-between mb-2">
                  <div className="text-xl sm:text-2xl font-extrabold font-mono text-amber-400">2023</div>
                  <div className="p-1.5 rounded-lg bg-amber-950/50 text-amber-400 border border-amber-500/20">
                    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<<<<<<< HEAD
              ...
              >
                ...
                <span className="text-xs font-semibold text-emerald-200 font-mono">SQL & Excel</span>
              </motion.div>

              {/* 5. Virtual Assistant Icon (Real Zoom Icon as requested) */}
              <motion.div
                animate={{ y: [-6, 6, -6] }}
                transition={{ duration: 4.2, repeat: Infinity, ease: 'easeInOut', delay: 1.6 }}
                className="absolute top-1/2 -left-8 z-20 flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-dark-900/90 border border-blue-400/40 shadow-glow-cyan backdrop-blur-md"
              >
